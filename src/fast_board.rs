...
impl FastBoard {
    ...
    pub fn place_stone(&mut self, x: usize, y: usize, stone: Stone) -> Result<(), String> {
    ...
    pub fn is_eye(&self, x: usize, y: usize, stone: Stone) -> bool {
        ...
        match diagonal_count {
            1 | 2 => opponent_diagonal_count == 0, // Corner/edge: all diagonals must be friendly
            4 => opponent_diagonal_count <= 1,     // Center: max 1 opponent stone on diagonals
            _ => false,
        }
    }
...
impl fmt::Display for FastBoard {
